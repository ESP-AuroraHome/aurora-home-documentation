    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--border-subtle)]">
          ...
          />
          {query && (
            <button onClick={() => setQuery("")} className="text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors">
              <X className="w-4 h-4" />
            </button>
          )}
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors ${
                      isSelected ? "bg-[var(--bg-muted)]" : "hover:bg-[var(--bg-card)]"
                    }`}
                    onClick={() => {
                  ...
                  >
                    <div className={`p-1.5 rounded-md ${isSelected ? "bg-[var(--bg-muted)]" : "bg-[var(--bg-card)]"}`}>
