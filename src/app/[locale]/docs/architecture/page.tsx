...
export default async function DocsArchitecture() {
							...
							<div className="min-w-0">
								...
								<ul className="space-y-2 text-sm text-neutral-400">
									<li className="flex items-start gap-2">
										...
										<span>{t("esp32Li1")}</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="w-1.5 h-1.5 rounded-full bg-blue-500/50 mt-1.5 shrink-0" />
										<span>{t("esp32Li2")}</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="w-1.5 h-1.5 rounded-full bg-blue-500/50 mt-1.5 shrink-0" />
										<span>{t("esp32Li3")}</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="w-1.5 h-1.5 rounded-full bg-blue-500/50 mt-1.5 shrink-0" />
										<span>
						...
						<div className="flex items-start gap-4">
							...
							<div className="min-w-0">
								...
								<ul className="space-y-2 text-sm text-neutral-400">
									...
									<li className="flex items-start gap-2">
										<span className="w-1.5 h-1.5 rounded-full bg-green-500/50 mt-1.5 shrink-0" />
										<span>{t("frontendLi4")}</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="w-1.5 h-1.5 rounded-full bg-green-500/50 mt-1.5 shrink-0" />
										<span>{t("frontendLi5")}</span>
									</li>
								</ul>
							</div>
						</div>
  ...
  "light": "320 lx"
				...
				<p className="mt-4 text-sm text-neutral-500">{t("mqttPayloadNote")}</p>
			</div>
			...
			<div className="mb-12">
				...
				<div className="grid gap-4">
					{[
						...
						>
							<h3 className={`font-semibold mb-2 text-${item.color}-300`}>
								{item.title}
							</h3>
