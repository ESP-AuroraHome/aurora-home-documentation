					...
					{[
						{
							...
							descKey: "cmdSimulateDesc",
							color: "green",
						},
						{
							cmd: "npm run simulate:co2",
							descKey: "cmdSimulateCo2Desc",
							color: "neutral",
						},
						{
							cmd: "npm run simulate:temp",
							descKey: "cmdSimulateTempDesc",
							color: "yellow",
						},
						{
							cmd: "npm run simulate:hum",
							descKey: "cmdSimulateHumDesc",
							color: "blue",
						},
						{
							cmd: "npm run simulate:sudden",
							descKey: "cmdSimulateSuddenDesc",
							color: "red",
						},
...
[10:32:07] step=  3 | T= 21.4°C  H= 55.1%  P= 1013.3hPa  CO₂= 712ppm  L= 321lx`}</CodeBlock>
			...
			<div className="mb-12">
				...
				<p className="text-neutral-400 mb-4">{t("endpointDesc")}</p>
  ...
  "light": "310"
			...
			<div className="mb-12">
				...
				<div className="grid gap-3">
					{[
						{
							cmd: "npm run seed:7days",
							descKey: "cmdSeed7daysDesc",
							color: "green",
						},
						{
							cmd: "npm run seed:7days:clear",
							descKey: "cmdSeed7daysClearDesc",
							color: "yellow",
						},
						{
							cmd: "npm run test:iaq",
							descKey: "cmdTestIaqDesc",
							color: "blue",
						},
						{
							cmd: "npm run test:iaq:excellent",
							descKey: "cmdTestIaqExcellentDesc",
							color: "emerald",
						},
						{
							cmd: "npm run test:iaq:good",
							descKey: "cmdTestIaqGoodDesc",
							color: "green",
						},
						{
							cmd: "npm run test:iaq:moderate",
							descKey: "cmdTestIaqModerateDesc",
							color: "yellow",
						},
						{
							cmd: "npm run test:iaq:poor",
							descKey: "cmdTestIaqPoorDesc",
							color: "red",
						},
					].map(({ cmd, descKey, color }) => (
						<div
