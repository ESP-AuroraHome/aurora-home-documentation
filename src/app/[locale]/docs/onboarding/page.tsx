			...
			<div className="mb-12">
				...
				<div>
					...
					<Step number={2} title={t("step2Title")}>
						{t("step2Desc")}{" "}
						<strong className="text-white">{t("step2Strong")}</strong>
						{t("step2Desc2")}
						<div className="mt-3 flex flex-wrap gap-2">
							{[
								...
								<span
									key={style}
									className="text-xs px-2 py-0.5 rounded bg-white/5 text-neutral-500 font-mono"
								>
									{style}
								</span>
							))}
					...
					<Step number={3} title={t("step3Title")}>
						{t("step3Desc")}{" "}
						<strong className="text-white">{t("step3Lang1")}</strong>{" "}
						{t("step3Or")}{" "}
				...
				<div className="p-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5">
					<div className="flex items-start gap-4">
						...
						<div>
							...
							<p className="text-sm text-neutral-400 leading-relaxed">
								{t("validationDesc")}
								<code className="mx-1 px-1.5 py-0.5 bg-white/5 rounded text-green-400">
									onboardingCompleted
								</code>
								{t("validationDesc2")}{" "}
								<code className="px-1.5 py-0.5 bg-white/5 rounded text-blue-400">
