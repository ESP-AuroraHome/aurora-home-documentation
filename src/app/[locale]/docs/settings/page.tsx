					...
					{[
						{
							icon: ToggleLeft,
							color: "green",
							title: t("notifToggleTitle"),
							desc: t("notifToggleDesc"),
						},
						{
							icon: Bell,
							color: "yellow",
							title: t("notifSeverityTitle"),
							desc: t("notifSeverityDesc"),
						},
						{
							icon: Bell,
							color: "purple",
							title: t("notifQuietTitle"),
							desc: t("notifQuietDesc"),
						},
						...
						>
							<div
								className={`p-2.5 rounded-lg bg-${color}-500/10 flex-shrink-0`}
							>
						...
						<table className="w-full text-sm min-w-[360px]">
							<thead>
								<tr className="border-b border-white/10 bg-white/[0.03]">
									<th className="text-left px-4 py-3 text-neutral-300 font-semibold">
										{t("threshColSensor")}
									</th>
									<th className="text-left px-4 py-3 text-neutral-300 font-semibold">
										{t("threshColHigh")}
