import { ArrowRight, ShoppingCart, Globe, Package, CreditCard } from "lucide-react";
    ...
    <div>
        ...
        <div className="space-y-2">
          {routes.map((r) => (
            ...
            >
              ...
              <code className="text-sm text-green-400 shrink-0 w-32">{r.path}</code>
      ...
      <div className="mb-12 p-5 rounded-xl bg-purple-500/5 border border-purple-500/20">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-purple-300 mb-1">{t("noteTitleStripe")}</h3>
