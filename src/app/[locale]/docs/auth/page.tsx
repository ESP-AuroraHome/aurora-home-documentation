			...
			<div className="mb-12">
				...
				<div className="space-y-4">
					{[
						...
						>
							<div
								className={`p-3 rounded-lg bg-${item.color}-500/10 flex-shrink-0`}
							>
							...
							<div>
								<div className="flex items-center gap-3 mb-2">
									<span
										className={`text-xs font-mono px-2 py-0.5 rounded bg-${item.color}-500/10 text-${item.color}-400`}
									>
										{item.label}
									</span>
				...
				<div className="p-6 rounded-xl border border-white/10 bg-white/[0.02]">
					<div className="flex items-start gap-4">
						...
						<div>
							...
							<p className="text-sm text-neutral-400 leading-relaxed">
								{t("logoutDesc")}{" "}
								<strong className="text-white">{t("logoutButton")}</strong>{" "}
								{t("logoutDesc2")}
							</p>
						</div>
					</div>
