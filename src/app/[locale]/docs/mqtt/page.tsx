import { AlertTriangle, ArrowRight, Cpu, Zap } from "lucide-react";
...
export default async function DocsMqtt() {
	...
	return (
		<div>
			...
			<div className="mb-12">
				...
				<div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
					<p className="text-sm text-blue-200/70">
						{t("brokerNote")}{" "}
						<code className="px-1.5 py-0.5 bg-blue-500/20 rounded">
							MQTT_BROKER_URL
						</code>{" "}
						{t("brokerNote2")}{" "}
						<code className="px-1.5 py-0.5 bg-blue-500/20 rounded">.env</code>
						{t("brokerNote3")}
					</p>
				</div>
			</div>
			...
			<div className="mb-12">
				...
				<p className="text-neutral-400 mb-4">{t("payloadDesc")}</p>
  ...
  "light": "320 lx"
				...
				<p className="mt-4 text-sm text-neutral-500">{t("payloadNote")}</p>
			</div>
							...
							<div className="flex items-start gap-4">
								...
								<div className="flex-1">
									<div className="flex items-center gap-3 mb-2">
										...
										<code
											className={`text-xs px-2 py-0.5 rounded bg-${sensor.color}-500/10 text-${sensor.color}-400`}
										>
											{sensor.addr}
										</code>
									</div>
					...
					<div className="space-y-3 text-sm">
						{[
							...
							},
							{
								step: "4",
								label: t("lc4Label"),
								code: "dataPointRepository.create()",
								desc: t("lc4Desc"),
							},
							{
								step: "5",
								label: t("lc5Label"),
								code: "sensorEmitter.emit('sensor_update')",
								desc: t("lc5Desc"),
							},
							{
								step: "6",
								label: t("lc6Label"),
								code: "useSensorData hook",
								desc: t("lc6Desc"),
							},
						].map((item) => (
