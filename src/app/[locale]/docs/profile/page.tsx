					...
					<div className="p-6 rounded-xl border border-white/10 bg-white/[0.02]">
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-neutral-400 leading-relaxed">
									{t("avatarDesc")}{" "}
									<strong className="text-white">{t("avatarStrong")}</strong>{" "}
									{t("avatarDesc2")}
								</p>
					...
					<div className="p-6 rounded-xl border border-white/10 bg-white/[0.02]">
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-neutral-400 leading-relaxed">
									{t("langDesc")}{" "}
									<strong className="text-white">{t("langFr")}</strong>{" "}
									{t("langOr")}{" "}
									<strong className="text-white">{t("langEn")}</strong>
									{t("langDesc2")}
								</p>
							</div>
						</div>
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-neutral-400">
									{t("saveDesc")}
									<strong className="text-white"> {t("saveButton")}</strong>{" "}
									{t("saveDesc2")}
								</p>
							</div>
						</div>
