			...
			<div className="mb-12">
				...
				<div className="grid gap-3">
					{[
						...
						{
							name: t("mqttBroker"),
							version: t("mqttBrokerVersion"),
							required: true,
						},
						{
							name: t("npmOrPnpm"),
							version: t("npmOrPnpmVersion"),
							required: true,
						},
						{
							name: t("prismaCli"),
							version: t("prismaCliVersion"),
							required: false,
						},
					].map((item) => (
						<div
				...
				<div className="grid gap-3">
					{[
						...
						<div
							...
							className="flex items-center justify-between p-4 rounded-lg bg-white/[0.02] border border-white/5"
						>
							<code className="text-sm text-green-400 min-w-0 truncate">
								{item.cmd}
							</code>
							<span className="text-sm text-neutral-500 hidden sm:block shrink-0">
								{item.desc}
							</span>
						</div>
					))}
