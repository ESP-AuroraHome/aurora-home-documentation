import { ArrowRight, GitBranch, Table } from "lucide-react";
			...
			<div className="mb-12">
				...
				<div className="grid gap-4">
					{[
						...
						},
						{
							...
							fields: [
								...
								{ name: "token", type: "String", note: t("sessionTokenNote") },
								{
									name: "expiresAt",
									type: "DateTime",
									note: t("sessionExpiresNote"),
								},
								{
									name: "ipAddress",
									type: "String?",
									note: t("sessionIpNote"),
								},
								{
									name: "userAgent",
									type: "String?",
									note: t("sessionUaNote"),
								},
								{
									name: "userId",
									type: "String",
									note: t("sessionUserIdNote"),
								},
							],
						},
						{
						...
						},
						{
							...
							fields: [
								{ name: "id", type: "String", note: "" },
								{
									name: "identifier",
									type: "String",
									note: t("verificationIdentifierNote"),
								},
								{
									name: "value",
									type: "String",
									note: t("verificationValueNote"),
								},
								{
									name: "expiresAt",
									type: "DateTime",
									note: t("verificationExpiresNote"),
								},
							],
						},
						{
							...
							fields: [
								{ name: "id", type: "String", note: t("dataPointIdNote") },
								{
									name: "type",
									type: "DataType",
									note: t("dataPointTypeNote"),
								},
								{
									name: "value",
									type: "String",
									note: t("dataPointValueNote"),
								},
								{
									name: "createdAt",
									type: "DateTime",
									note: t("dataPointCreatedNote"),
								},
							],
						},
						{
							...
							fields: [
								...
								{ name: "type", type: "AlertType", note: t("alertTypeNote") },
								{
									name: "severity",
									type: "Severity",
									note: t("alertSeverityNote"),
								},
								{
									name: "sensorType",
									type: "DataType",
									note: t("alertSensorTypeNote"),
								},
								{ name: "value", type: "Float", note: t("alertValueNote") },
								{
									name: "threshold",
									type: "Float?",
									note: t("alertThresholdNote"),
								},
								{
									name: "message",
									type: "String",
									note: t("alertMessageNote"),
								},
								{
									name: "suggestions",
									type: "String",
									note: t("alertSuggestionsNote"),
								},
								{ name: "read", type: "Boolean", note: t("alertReadNote") },
								{
									name: "resolvedAt",
									type: "DateTime?",
									note: t("alertResolvedNote"),
								},
								{ name: "createdAt", type: "DateTime", note: "" },
							],
						},
						...
						>
							<div
								className={`px-6 py-4 bg-${model.color}-500/5 border-b border-white/5 flex items-center gap-3`}
							>
					...
					{[
						{
							...
							fields: [
								...
								},
								{
									name: "highValue",
									type: "Float?",
									note: t("systemThresholdHighValueNote"),
								},
								{
									name: "highSeverity",
									type: "Severity?",
									note: t("systemThresholdHighSeverityNote"),
								},
								{
									name: "lowValue",
									type: "Float?",
									note: t("systemThresholdLowValueNote"),
								},
								{
									name: "lowSeverity",
									type: "Severity?",
									note: t("systemThresholdLowSeverityNote"),
								},
								{ name: "updatedAt", type: "DateTime", note: "" },
							],
						},
						{
							...
							fields: [
								...
								},
								{
									name: "enabled",
									type: "Boolean",
									note: t("sensorPrefEnabledNote"),
								},
								{
									name: "minSeverity",
									type: "Severity",
									note: t("sensorPrefMinSeverityNote"),
								},
								{ name: "updatedAt", type: "DateTime", note: "" },
							],
						},
						{
							...
							fields: [
								{ name: "id", type: "String", note: t("notifSettingsIdNote") },
								{
									name: "quietStart",
									type: "Int?",
									note: t("notifSettingsQuietStartNote"),
								},
								{
									name: "quietEnd",
									type: "Int?",
									note: t("notifSettingsQuietEndNote"),
								},
								{ name: "updatedAt", type: "DateTime", note: "" },
							],
						},
  ...
  CRITICAL  // Urgent — valeur dangereuse
				...
				<div className="mt-4 p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
					<p className="text-sm text-orange-200/70">
						<strong className="text-orange-300">{t("enumNote")}</strong>{" "}
						{t("enumDesc")}{" "}
						<code className="px-1.5 py-0.5 bg-orange-500/20 rounded">
							value
						</code>{" "}
						{t("enumDesc2")}
			...
			<div className="mb-12">
				...
				<div className="grid gap-3">
					{[
						...
						{
							cmd: "npx tsx prisma/seedFakeData.ts",
							desc: t("prismaCmd4Desc"),
						},
