			...
			<div className="p-6 rounded-xl bg-gradient-to-r from-white/5 to-white/[0.02] border border-white/10 mb-12">
				<div className="flex flex-col sm:flex-row sm:items-center gap-4">
					<div className="flex-1">
						...
						<p className="text-sm text-neutral-400">{t("ctaDesc")}</p>
					</div>
					<Link
						href="/docs/installation"
						className="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-lg text-sm font-medium hover:bg-neutral-200 transition-colors whitespace-nowrap self-start sm:self-auto"
					>
						{t("ctaButton")}
