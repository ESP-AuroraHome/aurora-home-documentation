	...
	return (
		<div>
			...
			<div className="mb-12">
				...
				<p className="text-neutral-400 mb-6">{t("sensorsIntro")}</p>
			...
			<div className="mb-12">
				...
				<div className="grid gap-3">
					...
					<div className="p-4 rounded-xl border border-red-500/30 bg-red-500/10">
						...
						<p className="text-sm text-neutral-400">{t("bannerAlertDesc")}</p>
					</div>
					<div className="p-4 rounded-xl border border-white/10 bg-white/[0.02]">
						<p className="text-sm font-medium text-white mb-1">
							{t("bannerWatchingTitle")}
						</p>
				...
				<p className="text-sm text-neutral-500 mt-4">
					→ {t("bannerLinkText")}{" "}
					<a href="/docs/alerts" className="text-blue-400 hover:underline">
						{t("bannerLinkLabel")}
					</a>{" "}
					{t("bannerLinkSuffix")}
				</p>
			...
			<div className="mb-12">
				...
				<h3 className="font-semibold mb-3 text-neutral-200">
					{t("iaqLevelsTitle")}
				</h3>
				<div className="grid gap-3">
					{[
						{
							label: t("iaqExcellent"),
							desc: t("iaqExcellentDesc"),
							color: "emerald",
						},
						{ label: t("iaqGood"), desc: t("iaqGoodDesc"), color: "green" },
						{
							label: t("iaqModerate"),
							desc: t("iaqModerateDesc"),
							color: "yellow",
						},
						...
						<div
							key={level.label}
							className={`p-4 rounded-xl border border-${level.color}-500/30 bg-${level.color}-500/5`}
						>
							<p
								className={`font-semibold text-sm text-${level.color}-300 mb-1`}
							>
								{level.label}
							</p>
						...
						<div className="flex-1">
							...
							<div className="flex gap-2 flex-wrap mb-4">
								{["Live", "1h", "6h", "24h", "7j"].map((btn) => (
									<span
										key={btn}
										className="text-xs px-3 py-1 rounded-full bg-white/10 text-white font-mono font-medium"
									>
										{btn}
									</span>
								))}
			...
			<div className="p-6 rounded-xl border border-white/10 bg-white/[0.02]">
				<div className="flex items-start gap-4">
					...
					<div>
						...
						<p className="text-sm text-neutral-400 leading-relaxed">
							{t("pwaDesc")}{" "}
							<strong className="text-white">{t("pwaAndroid")}</strong>
							{t("pwaDescMid")}{" "}
							<strong className="text-white">{t("pwaIphone")}</strong>
							{t("pwaDescEnd")}
						</p>
					</div>
				</div>
